...
for i in dictDataFrames.keys():
    exportLink = 'C:/Users/aleks/OneDrive/Documents/GitHub/OpenDataCustomerAnalytics/demographicsEducation/canton/{0}/CantonRelative/{1}_demographicsEducation_CantonRelative.csv'.format(i[-2:], i)
